...
def tagInstructions():
    ...
    tagged1.append(
        [('Wash and dry all produce.', 'Wash'),
         ('Adjust rack to upper position and preheat oven to 425 degrees.', 'Preheat'),
         ('Bring a large pot of salted water to a boil.', 'Boil'),
         ...
         ('Cook, stirring occasionally, until al dente, 9-11 minutes.', 'Cook'),
         ('Drain, then return to pot.', 'Drain'),
         ...
         ('Open each up and season all over with salt, pepper, and remaining Italian seasoning.', 'Season'),
         ('Heat a drizzle of olive oil in a large pan over medium-high heat.', 'Heat'),
         ('Add chicken and cook until no longer pink in center, 3-4...', 'Cook'),
         ('Flip and cook until browned and cooked through, 2-3 minutes more.', 'Cook'),
...
def to_freq_dist(instruction):
    regex = r"[a-zA-Z0-9_\/\’]+"  # splits string into individual words, removes commas and parenthesis
    tokens = regexp_tokenize(instruction, pattern=regex)
